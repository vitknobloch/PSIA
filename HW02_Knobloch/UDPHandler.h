...
#define DEFAULT_TIMEOUT 1.0 //default single packet timeout in seconds
#define SPEEDCAP 100 //max number of packets to send per sencond (timed-out included)
...
private:
	...
	double roundtrip_sum; //sum of all roundtrip times in seconds
	int roundtrip_count; //count of all roundtrips
